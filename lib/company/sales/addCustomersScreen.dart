                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            child: TextField(
                              focusNode: mainProvider.focusName,
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextField(
                              focusNode: mainProvider.focusContact,
                              style:GoogleFonts.notoSans(textStyle:  TextStyle(color: clblack)),
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            child: TextField(
                              focusNode: mainProvider.focusEmail,
                              style:GoogleFonts.notoSans(textStyle:  TextStyle(color: clblack)),
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextField(
                              focusNode: mainProvider.focusBilling,
                              style:GoogleFonts.notoSans(textStyle:  TextStyle(color: clblack)),
                              keyboardType: TextInputType.text,
                              decoration: InputDecoration(
                                isDense: true, // Reduces vertical spacing
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            child: TextField(
                              focusNode: mainProvider.focusPerson,
                              style:GoogleFonts.notoSans(textStyle:  TextStyle(color: clblack)),
                              keyboardType: TextInputType.phone,
                              decoration: InputDecoration(
                                isDense: true, // Reduces vertical spacing
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextField(
                              focusNode: mainProvider.focusTax,
                              style:GoogleFonts.notoSans(textStyle:  TextStyle(color: clblack)),
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            child: TextField(
                              focusNode: mainProvider.focusOpening,
                              style:GoogleFonts.notoSans(textStyle:  TextStyle(color: clblack)),
                              keyboardType: TextInputType.number,
                              decoration: InputDecoration(
                                isDense: true, // Reduces vertical spacing
