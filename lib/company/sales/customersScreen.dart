                          ...
                          Expanded(
                            child: SingleChildScrollView(
                              ...
                              children: [
                                ...
                                // Table Rows
                                Column(
                                  children: _buildCustomersListRows(context),
                                ),
                              ],
                            ),
                            ),
...
List<Widget> _buildCustomersListRows(BuildContext context) {
  var width = MediaQuery.of(context).size.width;

  // Dummy data
  final List<Map<String, String>> dummyList = [
    {
      'customerName': 'TechWave Innovations',
    ...
    {
      'customerName': 'ElectroVibe Technologies',
      'contactNumber': '+48 785345678',
      'email': 'support@vistulainnovations.com',
    },
    {
      'customerName': 'Circuit City Electronics',
      'contactNumber': '+48 586345678',
      'email': 'hello@polishsoftwarehub.com',
    },
    {
      'customerName': 'SmartGadgets Agency',
      'contactNumber': '+48 536345678',
      'email': 'team@warsawcreative.com',
    },
    {
      'customerName': 'NeonTech Systems',
      'contactNumber': '+48 512345678',
      'email': 'connect@gdanskitsolutions.com',
    },
    {
      'customerName': 'Quantum Electronics Group',
      'contactNumber': '+48 658345678',
      'email': 'info@silesiaconsulting.com',
    },
    {
      'customerName': 'DigitalWave Partners',
      'contactNumber': '+48 512345678',
      'email': 'contact@lublintechpartners.com',
    },
      ...
      child: Row(
        children: [
          ...
          SizedBox(
            ...
            child: InkWell(
              onTap: () {
               callNext(SalesRecordScreen(), context);
              },
              child: Text(
                'Invoices',
                style: GoogleFonts.notoSans(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _buildInfoItem("Customer Name", "TechWave Innovations"),
                          SizedBox(height: 16,),
                          _buildInfoItem("Email", "contact@krakowtech.com"),
                          SizedBox(height: 16,),
                          _buildInfoItem("Opening Balance", "zł1,000"),
                          SizedBox(height: 16,),
                          _buildInfoItem("Tax ID", "123-456-32-18"),
                          SizedBox(height: 16,),
                          _buildInfoItem("Customer ID", "C1001"),
                        ],
                      ),
                    ),
                    SizedBox(width: 8,),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _buildInfoItem("IContact Number", "+48 512345678"),
                          SizedBox(height: 16,),
                          _buildInfoItem("Contact Person", "Lucas Hayes"),
                          SizedBox(height: 16,),
                          _buildInfoItem("Billing Address", "123 Innovation Way, Krakow, Poland"),
                          SizedBox(height: 16,),
                          _buildInfoItem("Added Date", "12-05-2025"),
                        ],
                      ),
                    )
                  ],
