        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Text('Payment Portal', style: GoogleFonts.notoSans(fontWeight: FontWeight.w600, fontSize: 19, color: Colors.black)),
                OutlinedButton(
                  ...
                  child: Row(
                    children: [
                      Text('View Ledger', style: GoogleFonts.notoSans(fontSize: 14, color: cl8F1A3F, fontWeight: FontWeight.w500)),
                      const SizedBox(width: 4),
                      const Icon(Icons.arrow_forward_ios, size: 12, color: Color(0xFF8F1A3F)),
                    ],
                  ),
                ),
              ],
                        ...
                        child: Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              items: const [DropdownMenuItem(value: 'Cash in Hand', child: Text('Cash in Hand')), DropdownMenuItem(value: 'Bank', child: Text('Bank'))],
                              onChanged: (value) {
                              ...
                              decoration: InputDecoration(
                                ...
                                label: RichText(
                                  text: TextSpan(
                                    text: 'Account ',
                                    style: GoogleFonts.notoSans(textStyle: const TextStyle(color: Colors.grey, fontSize: 16)),
                              ...
                              style: GoogleFonts.notoSans(textStyle: TextStyle(color: clblack, fontSize: 16)),
                            ),
                          ),
                        ),
                      ),
