                            ...
                            child: Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text('Tomasz Tomaszewski', style: GoogleFonts.notoSans(textStyle: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w500))),
                                    Text('tomasz@gmail.com', style: GoogleFonts.notoSans(textStyle: TextStyle(color: clCCCCCC, fontSize: 10, fontWeight: FontWeight.w400))),
                                  ],
                                ),
                              ],
                            ),
  ...
  Widget _buildAdminButton() {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        padding: const EdgeInsets.symmetric(horizontal: 16),
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: isSelected ? Colors.white : Colors.transparent),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Image.asset('asset/icons/adminIcon.png', color: isSelected ? Colors.black : Colors.white, scale: 4),
            const SizedBox(width: 8),
            Text('Admin', style: GoogleFonts.openSans(textStyle: TextStyle(color: isSelected ? Colors.black : Colors.white, fontWeight: FontWeight.w500, fontSize: 14))),
          ],
        ),
      ),
    );
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Image.asset('asset/icons/companyIcon.png', color: isSelected ? Colors.black : Colors.white, scale: 4),
            const SizedBox(width: 8),
            Consumer<MainProvider>(
              builder:
                  (context, person, child) => Text(
                    person.companies[index].companyName,
                    style: GoogleFonts.openSans(textStyle: TextStyle(color: isSelected ? Colors.black : Colors.white, fontWeight: FontWeight.w500, fontSize: 14)),
                  ),
            ),
          ],
        ),
