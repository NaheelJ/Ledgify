                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        borderRadius: BorderRadius.circular(9), // Optional: Add slight rounding
                                      ),
                                      child: Center(
                                        child: Text(
                                          "High",
                                ...
                                Expanded(
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: clF2F2F2, // background color
                                        borderRadius: BorderRadius.circular(8), // Optional: Add slight rounding
                                      ),
                                      child: Center(
                                        child: Text(
                                          "Medium",
