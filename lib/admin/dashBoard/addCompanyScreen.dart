          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Text('Add Company', style: GoogleFonts.notoSans(fontWeight: FontWeight.w600, fontSize: 19, color: Colors.black)),
              ],
            ),
          ),
        ),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Flexible(child: Text('Added New Company ', style: GoogleFonts.notoSans(fontSize: 16, fontWeight: FontWeight.w800))),
                const SizedBox(height: 6),
                Flexible(child: Text('The company has been successfully added.', style: GoogleFonts.notoSans(fontSize: 14, fontWeight: FontWeight.w400, color: cl808080))),
              ],
            ),
          ),
        );
